...
class CocktailActivity : AppCompatActivity() {
    ...
    private var favesChangeListener: FavesChangeListener? = null
    ...
    private fun loadCocktail(id: Int) {
        if(Connectivity.isConnected(this)){
            ...
            val fetchCocktail = JsonObjectRequest(Request.Method.GET, BartenderUtil.COCKTAIL + id, null, Response.Listener { response ->
                try {
    ...
    interface FavesChangeListener {
        fun favesChanged()
    }

    fun refreshFaves(favesChangeListener: FavesChangeListener){
        this.favesChangeListener = favesChangeListener
    }
